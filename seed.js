  ...
  try {
    ...
    const plants = [
      ...
      },
      {
        ...
        avgPriceNow: 9000,
        category: categories[1]._id,
        description: "Tiêu tươi, dễ trồng",
        image: "https://example.com/images/raumuong.jpg",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        avgPriceNow: 9000,
        category: categories[1]._id,
        description: "ĐiềuĐiều tươi, dễ trồng",
        image: "https://example.com/images/raumuong.jpg",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        avgPriceNow: 9000,
        category: categories[0]._id,
        description: "sầu riêng tươi, dễ trồng",
        image: "https://example.com/images/raumuong.jpg",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        avgPriceNow: 9000,
        category: categories[1]._id,
        description: "thông tươi, dễ trồng",
        image: "https://example.com/images/raumuong.jpg",
        createdAt: new Date(),
        updatedAt: new Date(),
      },      
