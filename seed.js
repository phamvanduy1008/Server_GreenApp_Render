...
const products = [      
  ...
  },
  {
    ...
    name: "Cà phê Robusta",
    price: 18000,
    info: "Vị đậm đà, caffeine cao, phù hợp gu mạnh",
  ...
  },
  {
    ...
    name: "Cà phê Moka",
    price: 22000,
    info: "Hương vị quyến rũ, thơm nồng",
    image: "https://example.com/images/moka.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[1]._id,
    plant: plants[0]._id,
  ...
  },
  {
    ...
    name: "Cà phê Culi",
    price: 24000,
    info: "Đậm đà, hậu vị mạnh",
    image: "https://example.com/images/culi.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[1]._id,
    plant: plants[0]._id,
  ...
  },
  {
    ...
    name: "Cà phê Chồn",
    price: 80000,
    info: "Đặc sản quý hiếm, hương vị độc đáo",
    image: "https://example.com/images/chon.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[1]._id,
    plant: plants[0]._id,
  ...
  {
    _id: new ObjectId(),
    name: "Chuối tiêu chín cây",
    price: 15000,
    info: "Chuối ngọt, dẻo, trồng tự nhiên",
    image: "https://example.com/images/chuoi.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[0]._id,
    plant: plants[3]._id,
  ...
  },
  {
    ...
    price: 18000,
    info: "Dưa hấu đỏ mọng, ngọt lịm",
    image: "https://example.com/images/duahau.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[0]._id,
    plant: plants[1]._id,
  ...
  },
  {
    ...
    price: 30000,
    info: "Nhãn thơm, cơm dày, ít hạt",
    image: "https://example.com/images/nhan.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[0]._id,
    plant: plants[1]._id,
  ...
  },
  {
    ...
    name: "Lúa ST25",
    price: 7000,
    info: "Gạo ngon nhất thế giới, thơm tự nhiên",
    image: "https://example.com/images/st25.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[2]._id,
    plant: plants[2]._id,
  ...
  },
  {
    ...
    name: "Lúa Bắc Hương",
    price: 5500,
    info: "Giống lúa truyền thống miền Bắc",
    image: "https://example.com/images/backhuong.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[2]._id,
    plant: plants[2]._id,
  ...
  },
  {
    ...
    name: "Lúa IR50404",
    price: 5000,
    info: "Giống phổ biến, năng suất cao",
    image: "https://example.com/images/ir50404.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[2]._id,
    plant: plants[2]._id,
  ...
  },
  {
    ...
    name: "Cải ngọt sạch",
    price: 12000,
    info: "Tươi ngon, thu hoạch trong ngày",
    image: "https://example.com/images/caingot.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[3]._id,
    plant: plants[4]._id,
  ...
  },
  {
    ...
    name: "Rau dền tươi",
    price: 10000,
    info: "Rau dền đỏ giàu sắt, tốt cho máu",
    image: "https://example.com/images/rauden.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[3]._id,
    plant: plants[4]._id,
  ...
  },
  {
    ...
    name: "Cải thìa",
    price: 11000,
    info: "Cải thìa xanh, giòn, sạch",
    image: "https://example.com/images/caithia.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[3]._id,
    plant: plants[4]._id,
  ...
  },
  {
    ...
    name: "Rau má sạch",
    price: 9000,
    info: "Rau má giải nhiệt, sạch không hóa chất",
    image: "https://example.com/images/rauma.jpg",
    status: "available",
    evaluate: Math.random() * (5 - 4) + 4,
    category: categories[3]._id,
    plant: plants[4]._id,
